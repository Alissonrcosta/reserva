                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    include 'conecta.php';
                                    $pesquisa = mysqli_query($conn, "SELECT reserva.id as idreserva,reserva.id_funcionario,reserva.id_carro,reserva.data_inicial,reserva.data_final,reserva.descricao, funcionario.nome, carro.modelo FROM reserva inner join funcionario on reserva.id_funcionario=funcionario.id inner join carro on reserva.id_carro=carro.id;");
                                    ...
                                    if($row > 0){
                                        while($registro = $pesquisa->fetch_array()){
                                            ...
                                            echo '<td><a href="editares.php?id='.$registro['idreserva'].'">Editar</a> | <a href="excluires.php?id='.$registro['idreserva'].'">Excluir</a></td>';
                                            echo '</tr>';
                                        }
                                        echo '</tbody>';
                                        echo '</table>';
