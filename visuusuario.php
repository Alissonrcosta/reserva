...
<body>
    ...
    <center>
        ...
        <br />
        <a href="cadusuario.php"><button type="button" class="btn btn-outline-light">Cadastrar Usuário</button></a>
                                ...
                                <?php
                                    ...
                                    if($row > 0){
                                        while($registro = $pesquisa->fetch_array()){
                                            ...
                                            echo '<td><a href="editausuario.php?id='.$registro['id'].'">Editar</a> | <a href="excluiusuario.php?id='.$registro['id'].'">Excluir</a></td>';
                                            echo '</tr>';
                                        }
                                        echo '</tbody>';
                                        echo '</table>';
