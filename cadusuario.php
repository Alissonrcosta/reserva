                    ...
                    <div class="card-body">
                        <form action="cadusu.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="login" placeholder="Digite o seu nome de usuário" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Senha</label>
                                <input type="text" class="form-control" name="senha" placeholder="Digite uma senha.">
                            </div>
                            <button type="submit" class="btn btn-outline-success">Cadastrar</button>
                            <a href="visuusuario.php"><button type="button" class="btn btn-outline-secondary">Voltar</button></a>
                        </form>
                    </div>
                </div>
            </div>
